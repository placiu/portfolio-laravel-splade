...
<x-layout>
    <x-content>
        <div class="flex flex-col w-full h-full justify-center space-y-10">
            ...
            <div class="flex flex-col space-y-2 px-20 font-sans text-secondary">
            ...
            <div class="flex px-20 gap-4 font-sans text-accent flex-wrap">
                @foreach ($softwares as $software)
                    <a href="{{ $software['url'] }}" class="flex px-4 py-3 bg-dark border-2 border-accent text-accent rounded-md hover:bg-accent hover:text-dark">
